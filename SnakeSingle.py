        ...
        for i,c in enumerate(self.body):
            ...
            if p in self.turns:
                ...
                if c.dirnx==-1 and c.pos[0]<=0:
                    c.pos=(c.r-1,c.pos[1])
                elif c.dirnx==1 and c.pos[0]>=c.r-1:
                    c.pos=(0,c.pos[1])
                elif c.dirny==1 and c.pos[1]>=c.r-1:
                    c.pos=(c.pos[0],0)
    ...
    def draw(self,surface):
        for i,c in enumerate(self.body):
            if i==0:
                ...
                c.draw(surface)
def drawGrid(z,r,surface):
    sizeBtwn=z//r 
    x,y=0,0
    for i in range(r):
        x+=sizeBtwn
        y+=sizeBtwn
        pygame.draw.line(surface,(255,255,255),(x,0),(x,z))
        pygame.draw.line(surface,(255,255,255),(0,y),(z,y))   
...
def main():
    ...
    snack=cube(randomSnack(r,s),color=(0,255,0))
    flag=True
